...
open class AssetsPickerConfig {
    ...
    public let albumPortraitDefaultColumnCount: Int = 1
    ...
    public let albumLandscapeDefaultColumnCount: Int = 1
    ...
    open func prepare() -> Self {
        ...
        albumPortraitCellSize = CGSize(
            ...
            height: 80
            //albumPortraitForcedCellHeight ?? albumPortraitWidth * 1.25
        )
        ...
        //}
        albumLandscapeWidth = UIScreen.main.landscapeSize.width - 90

        albumLandscapeCellSize = CGSize(
            //width: 100,
            width: albumLandscapeForcedCellWidth ?? albumLandscapeWidth,
            height: 80
            //albumLandscapeForcedCellHeight ?? albumLandscapeWidth * 1.25
        )
