...
open class AssetsAlbumViewController: UIViewController {
    ...
    var assetsPhotoViewViewController: UIViewController?
    ...
    var countOfPhotos: Int = 0 {
        didSet {
            ...
            updateStatusButton(count: self.countOfPhotos)
        }
    }
    
    private  func updateStatusButton(count: Int) {
    
            self.statusView.updateStatusView(count: count, animated: false)
        }
    ...
    open override func viewWillAppear(_ animated: Bool) {
        ...
        //        statusView.updateStatusView(count: countOfPhotos, animated: false)
    }
...
extension AssetsAlbumViewController: UICollectionViewDelegate {
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(assetsPhotoViewViewController!, animated: true)
