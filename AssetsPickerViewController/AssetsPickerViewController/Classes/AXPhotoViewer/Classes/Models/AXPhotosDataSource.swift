...
@objc open class AXPhotosDataSource: NSObject {
    ...
    @objc public init(photos: [AXPhotoProtocol], selectedPhotos: [PHAsset], initialPhotoIndex: Int, prefetchBehavior: AXPhotosPrefetchBehavior) {
        self.photos = photos
